...
internal object GetProductListMapper : Mapper<GetProductListResponse, List<ProductData>> {
    override fun mapToData(from: GetProductListResponse): List<ProductData> {
